...
public class Constants {
    ...
    private static final String NDEF_DOMAIN = "i2p.bote";
    private static final String NDEF_TYPE_CONTACT = "contact";
    private static final String NDEF_TYPE_CONTACT_DESTINATION = "contactDestination";
